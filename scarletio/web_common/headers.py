...
METHOD_GET_ALL = frozenset((METHOD_HEAD, METHOD_GET, METHOD_OPTIONS))
METHOD_POST_ALL = frozenset((METHOD_PATCH, METHOD_POST, METHOD_PUT))

METHOD_ALL = frozenset((
    METHOD_CONNECT, METHOD_HEAD, METHOD_DELETE, METHOD_GET, METHOD_OPTIONS, METHOD_PATCH, METHOD_POST, METHOD_PUT,
    METHOD_TRACE
))
...
SEC_WEB_SOCKET_ACCEPT = IgnoreCaseString('Sec-WebSocket-Accept')
SEC_WEB_SOCKET_VERSION = IgnoreCaseString('Sec-WebSocket-Version')
SEC_WEB_SOCKET_PROTOCOL = IgnoreCaseString('Sec-WebSocket-Protocol')
SEC_WEB_SOCKET_EXTENSIONS = IgnoreCaseString('Sec-WebSocket-Extensions')
SEC_WEB_SOCKET_KEY = IgnoreCaseString('Sec-WebSocket-Key')
SEC_WEB_SOCKET_KEY1 = IgnoreCaseString('Sec-WebSocket-Key1')
...
WEB_SOCKET = IgnoreCaseString('WebSocket')
