...
from .token_types import (
    ...
    TOKEN_TYPE_CONSOLE_BANNER_LOGO, TOKEN_TYPE_CONSOLE_MARKER, TOKEN_TYPE_DIFFERENCE_DELETED,
    TOKEN_TYPE_DIFFERENCE_INSERTED, TOKEN_TYPE_IDENTIFIER_ATTRIBUTE, TOKEN_TYPE_IDENTIFIER_BUILTIN,
    TOKEN_TYPE_IDENTIFIER_BUILTIN_EXCEPTION, TOKEN_TYPE_IDENTIFIER_KEYWORD, TOKEN_TYPE_IDENTIFIER_MAGIC,
    TOKEN_TYPE_NON_SPACE, TOKEN_TYPE_NUMERIC, TOKEN_TYPE_SPECIAL_CONSOLE_PREFIX, TOKEN_TYPE_SPECIAL_OPERATOR,
    TOKEN_TYPE_SPECIAL_OPERATOR_ATTRIBUTE, TOKEN_TYPE_SPECIAL_PUNCTUATION, TOKEN_TYPE_STRING,
    TOKEN_TYPE_STRING_FORMAT_CODE, TOKEN_TYPE_STRING_FORMAT_MARK, TOKEN_TYPE_STRING_FORMAT_POSTFIX,
...
DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    TOKEN_TYPE_NUMERIC,
    FormatterDetailANSI(foreground_color = (182, 86, 255)),
)
DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    TOKEN_TYPE_STRING,
...
DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    ...
    FormatterDetailANSI(foreground_color = (255, 51, 51)),
)

DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    TOKEN_TYPE_TEXT_POSITIVE,
    FormatterDetailANSI(foreground_color = (51, 255, 51)),
)

DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    TOKEN_TYPE_TEXT_NEUTRAL,
    FormatterDetailANSI(foreground_color = (51, 255, 255)),
)

DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    TOKEN_TYPE_TEXT_UNKNOWN,
    FormatterDetailANSI(foreground_color = (255, 51, 255)),
)
...
DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    ...
    FormatterDetailANSI(background_color = (120, 40, 70)),
)

DEFAULT_ANSI_HIGHLIGHTER.set_highlight_detail(
    TOKEN_TYPE_DIFFERENCE_INSERTED,
    FormatterDetailANSI(background_color = (20, 100, 50)),
)
