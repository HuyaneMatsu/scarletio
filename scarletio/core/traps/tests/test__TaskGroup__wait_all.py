...
async def test__TaskGroup__wait_all__no_futures():
    """
...
async def test__TaskGroup__wait_all__result_set_before():
    """
    Tests whether ``TaskGroup.wait_all`` works as intended.
...
async def test__TaskGroup__wait_all__result_set_after():
    """
    Tests whether ``TaskGroup.wait_all`` works as intended.
