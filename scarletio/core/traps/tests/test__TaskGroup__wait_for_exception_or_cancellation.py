...
async def test__TaskGroup__wait_exception_or_cancellation__no_futures():
    """
    Tests whether ``TaskGroup.wait_exception_or_cancellation`` works as intended.
    ...
    waiter_0 = task_group.wait_exception_or_cancellation()
...
async def test__TaskGroup__wait_exception_or_cancellation__result_set_before():
    """
    Tests whether ``TaskGroup.wait_exception_or_cancellation`` works as intended.
...
async def test__TaskGroup__wait_exception_or_cancellation__result_set_after():
    """
    Tests whether ``TaskGroup.wait_exception_or_cancellation`` works as intended.
...
async def test__TaskGroup__wait_exception_or_cancellation__exception_set_before():
    """
    Tests whether ``TaskGroup.wait_exception_or_cancellation`` works as intended.
...
async def test__TaskGroup__wait_exception_or_cancellation__exception_set_after():
    """
    Tests whether ``TaskGroup.wait_exception_or_cancellation`` works as intended.
...
async def test__TaskGroup__wait_exception_or_cancellation__cancelled_before():
    """
    Tests whether ``TaskGroup.wait_exception_or_cancellation`` works as intended.
...
async def test__TaskGroup__wait_exception_or_cancellation__cancelled_after():
    """
    Tests whether ``TaskGroup.wait_exception_or_cancellation`` works as intended.
