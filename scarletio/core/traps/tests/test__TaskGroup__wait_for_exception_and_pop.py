...
async def test__TaskGroup__wait_exception_and_pop__no_futures():
    """
    ...
    waiter_0 = task_group.wait_exception_and_pop()
...
async def test__TaskGroup__wait_exception_and_pop__result_set_before():
    """
    Tests whether ``TaskGroup.wait_exception_and_pop`` works as intended.
...
async def test__TaskGroup__wait_exception_and_pop__result_set_after():
    """
    Tests whether ``TaskGroup.wait_exception_and_pop`` works as intended.
...
async def test__TaskGroup__wait_exception_and_pop__exception_set_before():
    """
    Tests whether ``TaskGroup.wait_exception_and_pop`` works as intended.
...
async def test__TaskGroup__wait_exception_and_pop__exception_set_after():
    """
    Tests whether ``TaskGroup.wait_exception_and_pop`` works as intended.
...
async def test__TaskGroup__wait_exception_and_pop__cancelled_before():
    """
    Tests whether ``TaskGroup.wait_exception_and_pop`` works as intended.
...
async def test__TaskGroup__wait_exception_and_pop__cancelled_after():
    """
    Tests whether ``TaskGroup.wait_exception_and_pop`` works as intended.
