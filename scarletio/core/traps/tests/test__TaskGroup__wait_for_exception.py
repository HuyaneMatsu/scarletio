...
async def test__TaskGroup__wait_exception__no_futures():
    """
...
async def test__TaskGroup__wait_exception__result_set_before():
    """
    Tests whether ``TaskGroup.wait_exception`` works as intended.
...
async def test__TaskGroup__wait_exception__result_set_after():
    """
    Tests whether ``TaskGroup.wait_exception`` works as intended.
...
async def test__TaskGroup__wait_exception__exception_set_before():
    """
    Tests whether ``TaskGroup.wait_exception`` works as intended.
...
async def test__TaskGroup__wait_exception__exception_set_after():
    """
    Tests whether ``TaskGroup.wait_exception`` works as intended.
...
async def test__TaskGroup__wait_exception__cancelled_before():
    """
    Tests whether ``TaskGroup.wait_exception`` works as intended.
...
async def test__TaskGroup__wait_exception__cancelled_after():
    """
    Tests whether ``TaskGroup.wait_exception`` works as intended.
