...
async def test__TaskGroup__wait_first_and_pop__no_futures():
    """
...
async def test__TaskGroup__wait_first_and_pop__result_set_before():
    """
    Tests whether ``TaskGroup.wait_first_and_pop`` works as intended.
...
async def test__TaskGroup__wait_first_and_pop__result_set_after():
    """
    Tests whether ``TaskGroup.wait_first_and_pop`` works as intended.
...
async def test__TaskGroup__wait_first_and_pop__exception_set_before():
    """
    Tests whether ``TaskGroup.wait_first_and_pop`` works as intended.
...
async def test__TaskGroup__wait_first_and_pop__exception_set_after():
    """
    Tests whether ``TaskGroup.wait_first_and_pop`` works as intended.
...
async def test__TaskGroup__wait_first_and_pop__cancelled_before():
    """
    Tests whether ``TaskGroup.wait_first_and_pop`` works as intended.
...
async def test__TaskGroup__wait_first_and_pop__cancelled_after():
    """
    Tests whether ``TaskGroup.wait_first_and_pop`` works as intended.
