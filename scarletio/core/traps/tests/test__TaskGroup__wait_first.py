...
async def test__TaskGroup__wait_first__no_futures():
    """
...
async def test__TaskGroup__wait_first__result_set_before():
    """
    Tests whether ``TaskGroup.wait_first`` works as intended.
...
async def test__TaskGroup__wait_first__result_set_after():
    """
    Tests whether ``TaskGroup.wait_first`` works as intended.
...
async def test__TaskGroup__wait_first__exception_set_before():
    """
    Tests whether ``TaskGroup.wait_first`` works as intended.
...
async def test__TaskGroup__wait_first__exception_set_after():
    """
    Tests whether ``TaskGroup.wait_first`` works as intended.
...
async def test__TaskGroup__wait_first__cancelled_before():
    """
    Tests whether ``TaskGroup.wait_first`` works as intended.
...
async def test__TaskGroup__wait_first__cancelled_after():
    """
    Tests whether ``TaskGroup.wait_first`` works as intended.
